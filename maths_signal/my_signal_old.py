...
class Signal:
    ...
    def samples(self, start_time, end_time):
        ...
        return [self.evaluate(i) for i in t]
    ...
    def spectrum(self, end_freq, acquisition_duration, unilateral = False, fourier_transform = False):
        ...
        t = np.linspace(-acquisition_duration/2, acquisition_duration/2, num_samples)
        ...
        if fourier_transform:
            ...
            spectrum = np.abs(np.fft.fft(y)) * acquisition_duration
        else:
